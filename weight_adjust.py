...
vali_batch_size = 256
test_batch_size = 256 
train_true_file = 'data/dbAMP/AMP.tr.fasta' 
train_false_file = 'data/dbAMP/Non-AMP.tr.fasta'
valid_true_file = 'data/dbAMP/AMP.valid.fasta'
valid_false_file = 'data/dbAMP/Non-AMP.valid.fasta'
test_true_file = 'data/dbAMP/AMP.te.fasta'
test_false_file = 'data/dbAMP/Non-AMP.te.fasta'
